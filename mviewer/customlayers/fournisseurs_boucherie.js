...
// 1. Infos de base
const ACTIVITY_FIELD = 'boucherie';
const LAYER_ID = 'fournisseurs_boucherie';
const LAYER_LABEL = 'Fournisseurs en boucherie';

// 2. Style du pictogramme (HYBRIDE: SVG prioritaire, sinon FontAwesome)
const BACKGROUND_COLOR = '#A52A2A';      // Couleur du cercle de fond (rouge brique)
const ICON_SVG_PATH = null;             // Chemin vers l'icône SVG (ex: 'statics/picto_boucherie.svg')
const ICON_UNICODE = '\uf5d7';          // Icône FontAwesome (os) si SVG non fourni
