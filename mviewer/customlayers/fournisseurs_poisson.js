...
// 1. Infos de base
const ACTIVITY_FIELD = 'poisson';
const LAYER_ID = 'fournisseurs_poisson';
const LAYER_LABEL = 'Fournisseurs en poissonnerie';

// 2. Style du pictogramme (HYBRIDE: SVG prioritaire, sinon FontAwesome)
const BACKGROUND_COLOR = '#4682B4';      // Couleur du cercle de fond (bleu marine)
const ICON_SVG_PATH = null;             // Chemin vers l'icône SVG (ex: 'statics/picto_poisson.svg')
const ICON_UNICODE = '\uf578';          // Icône FontAwesome (poisson) si SVG non fourni
